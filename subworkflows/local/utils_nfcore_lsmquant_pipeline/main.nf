//
// Subworkflow with functionality specific to the nf-core/lsmquant pipeline
//
...
\033[0;35m  nf-core/lsmquant ${workflow.manifest.version}\033[0m
-\033[2m----------------------------------------------------\033[0m-
"""
...
workflow PIPELINE_COMPLETION {
    ...
    multiqc_report  //  path: List of paths to MultiQC reports
